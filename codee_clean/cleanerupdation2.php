...
<div class="modal-header">
    ...
    top: -2px;"></center></button>
              ...
              <div class="modal-body21">
                ...
                <div class="form-group">
                    <input value="<?php echo($row['completion_scheduled_date']); ?>" type="text" onfocus="(this.type='date')" onblur="(this.type='text')" class="bday" name="date" id="calendardetailsdecode7" required>
                </div>
                <div class="form-group">
                    <input type="text" name="site_address" class="input_text2" value="<?php echo($row['site_address']); ?>" required>
                </div>
                <input type="hidden" name="taskedit44" value="addedit44">
