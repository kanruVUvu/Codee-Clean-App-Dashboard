...
<head>
    ...
    <title>CODEE App ClientDocuments</title>
...
<body class="best" style="width:1540px;margin:auto;">
		...
		<div class="wrapper col-md-2">
			<div class="sidebar col-md-2" id="sideways">
		        <ul class="menu">
		            ...
		            <li><img src="assets/images/docuhighlighted.png" class="documenticon"><a href="documents.php" class="dot" style="color: #FF6900;text-decoration:none;">DOCUMENTS<img src="assets/images/arrowiconsidebar.png" style="position: relative;
    width: 9.63px;
    height: 11.95px;
    right: -10px;
    top: -1px;"></a></li>
    ...
    right: 124px;"></h2>
				...
				<?php
                    include("database.php");
                    $q="select * from clientlisttable where client_name='$cname'";
    ...
    border-radius: 10px;">
				<?php if ($row['client_documentname']){ ?>
				<div style="position: relative;
    top: 12px;
    right: -16px;">
				<img src="assets/images/newfileimage.png" style="position:static;left:-8px"><a target="_blank" href="../documents/<?php echo $row['client_documentname']; ?>" style="font-family: Nunito Sans;
    font-style: normal;
    font-weight: normal;
    font-size: 14px;
    line-height: 19px;
    color: #000000;text-decoration:none;"><?php echo $row['client_documentname']; ?>
	             </div>
    ...
    height: 224px;">
	   ...
	   <br/>
        ...
        <div class="modal-footer">
          <input type="button" id="tasksbutton2" class="btn btn-default" data-dismiss="modal" value="CANCEL" onclick="window.location.href='documents.php'">
