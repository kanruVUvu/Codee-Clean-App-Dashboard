...
<head>
    ...
    <title>CODEE App ClientCompletedTasks</title>
			...
			<div class="sidebar col-md-2" id="sideways">
		        <ul class="menu">
		            <li class="sidebar-item  active">
	                    <a href="completedtask.php" class='sidebar-link'>
	                   ...
	                   <ul class="submenu">
	                        ...
	                        <li>
	                            <a href="completedtask.php" class="cmp" style="color: #FF6900;text-decoration:none;">Completed Tasks<img src="assets/images/arrowiconsidebar.png" style="position: relative;
    width: 9.63px;
    height: 11.95px;
    right: -10px;
    top: -1px;">
...
height: 1.6px;">TASKS</h2>
			<a href="completedtaskview2.php"><img src="assets/images/List View.png"class="list1"></a>
			<a href="completedtask.php"><img src="assets/images/Grid View.png" class="grid1"></a>
...
whatchat();
  ...
  $('#chatmodal').on('show.bs.modal', function(e) {
    ...
    $.ajax({
            type : 'post',
            url : 'https://outre.digital/stage/codee_clean_test/codee_clean/codee_clean_cleanerclient/chatpopuppageclient3.php', //Here you will fetch records
 ...
 <div class="modal fade" id="myModal" role="dialog">
  ...
  <input type="hidden" name="task13" value="add102">
    ...
    height: 224px;">
	   ...
	   <br/>
        ...
        <div class="modal-footer">
          <input type="button" id="tasksbutton2" class="btn btn-default" data-dismiss="modal" value="CANCEL" onclick="window.location.href='completedtask.php'">
