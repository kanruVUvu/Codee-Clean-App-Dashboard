...
<head>
    ...
    <title>CODEE App ClientNotifications</title>
...
<body class="best" style="width:1540px;margin:auto;">
		        ...
		        <ul class="menu">
		            <li class="sidebar-item  active">
	                    <a href="task.php" class='sidebar-link'>
	                        ...
	                        <a href="task.php" class="taskinfo" style="color:#010101;text-decoration:none;">TASK</a>
	                    </a>
	                    
	                    <ul class="submenu">
	                        <li>
	                            <a href="task.php" class="ong" style="text-decoration:none;color: #A6A6A6;">Ongoing Tasks 
	                            </a>
	                        </li>
	                        <li>
	                            <a href="completedtask.php" class="cmp" style="text-decoration:none;color: #A6A6A6;">Completed Tasks
	                            </a>
	                        </li>
	                    </ul>
	                </li>
		            <li><img src="assets/images/notihighlighted.png" class="notificationicon"><a href="notification.php" class="not" style="color: #FF6900;text-decoration:none;">NOTIFICATION<img src="assets/images/arrowiconsidebar.png" style="position: relative;
    width: 9.63px;
    height: 11.95px;
    right: -10px;
    top: -2px;"></a></li>
				...
				<form action="insert.php" method="POST" enctype="multipart/form-data">
                       <div class="info_table_wrapper" style="margin-bottom:20px;">
                        ...
                        <div class="stats_block" style="display: flex;flex-direction: row;  align-items: center;" >
                            ...
                            <h6 class="bdata" style="position: relative; left: -223px;
    top: 76.3px;font-family: Nunito Sans;font-style: normal;font-weight: normal;font-size: 12px;line-height: 25px;color: #393939;"><?php print_r(date('d M Y' , strtotime($row['completion_scheduled_date']))); ?></h6>
							</div>
                        </div>
						<input type="hidden" name="ID90" value="<?php echo($row['ID']); ?>">
						<input type="hidden" name="statuschangeclient1" value="colourchangeclient1">
						<div class="stats_block" style="display: flex;flex-direction: row;  align-items: center;" >
                            <div class="stats_details" style="text-align:right">
    ...
    top: 76.3px;font-family: Nunito Sans;font-style: normal;font-weight: normal;font-size: 12px;line-height: 25px;color: #393939;"><?php print_r(date('d M Y' , strtotime($row['completion_scheduled_date']))); ?></h6>
				...
				<?php
                    include("database.php");
                    $q="select * from cleanercompletedtasks where clientname='$cname' and textmessage='clientaddition'";
                    $result=mysqli_query($con,$q);
                    while($row=mysqli_fetch_array($result))
                    { 
                ?>
				...
				<form action="insert.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="stats_block" style="display: flex;flex-direction: row;  align-items: center;" >
                            ...
                            <h6 class="bdata" style="position: relative;left: -114px;top: 77px;font-family: Nunito Sans;font-style: normal;font-weight: normal;font-size: 12px;line-height: 25px;color: #393939;"><?php echo($row['site_address']); ?></h6>
							</div>
                        </div>
						<input type="hidden" name="ID90" value="<?php echo($row['ID']); ?>">
						<input type="hidden" name="statuschangeclient2" value="colourchangeclient2">
						<div class="stats_block" style="display: flex;flex-direction: row;  align-items: center;" >
                            <div class="stats_details" style="text-align:right">
                              <input type="submit" style="position: relative;width: 97px;height: 36px;left: -38px;top: 92px;background: #303030;border-radius: 4px;font-family: Nunito Sans;font-style: normal;font-weight: bold;font-size: 20px;line-height: 27px;color: #FFFFFF;" value="View">
                            </div>
				...
				?>
						...
						<div class="stats_block" style="display: flex;flex-direction: row;  align-items: center;" >
                            <div class="stats_details" style="text-align:right">
                             <a href="completedtask.php" style="text-decoration:none;"><input type="button" style="position: relative;width: 97px;height: 36px;left: -38px;top: 92px;background: #303030;border-radius: 4px;font-family: Nunito Sans;font-style: normal;font-weight: bold;font-size: 20px;line-height: 27px;color: #FFFFFF;" value="View"></a>
                            </div>
                        </div>
								</div>
                            </div>
				...
				<form action="insert.php" method="POST" enctype="multipart/form-data">
                       <div class="info_table_wrapper" style="margin-bottom:20px;">
                        ...
                        <div class="stats_block" style="display: flex;flex-direction: row;  align-items: center;"   >
                            <div class="stats_details" style="text-align:right">
                                <h6 class="stats_title" style="position: absolute;width: 258px;height: 17px;left: -87px;top: 86px;font-family: Nunito Sans;font-style: normal;font-weight: bold;font-size: 15px;line-height: 25px;color: #262626;">ASSIGNED PERSON</h6>
								<h6 class="bdata" style="position: relative;left: -4px;top: 74px;font-family: Nunito Sans;font-style: normal;font-weight: normal;font-size: 12px;line-height: 25px;color: #393939;"><img src="assets/images/<?php echo($row['cleanerimage']); ?>" style="width: 28%;">&nbsp;&nbsp;&nbsp;&nbsp;<?php print_r($row['cleaner']); ?></h6>
                            </div>
                        </div>
                        <div class="stats_block" style="display: flex;flex-direction: row;  align-items: center;" >
                            <div class="stats_details" style="text-align:right">
						...
						<input type="hidden" name="ID90" value="<?php echo($row['ID']); ?>">
						<input type="hidden" name="statuschangeclient3" value="colourchangeclient3">
						<div class="stats_block" style="display: flex;flex-direction: row;  align-items: center;" >
                            <div class="stats_details" style="text-align:right">
                             <input type="submit" style="position: relative;width: 97px;height: 36px;left: -38px;top: 92px;background: #303030;border-radius: 4px;font-family: Nunito Sans;font-style: normal;font-weight: bold;font-size: 20px;line-height: 27px;color: #FFFFFF;" value="View">
                            </div>
