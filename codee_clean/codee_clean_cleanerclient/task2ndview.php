...
<head>
    ...
    <title>CODEE App ClientTasks2ndview</title>
			...
			<div class="sidebar col-md-2" id="sideways">
		        <ul class="menu">
		            <li class="sidebar-item  active">
	                    ...
	                    <ul class="submenu">
	                        <li>
	                            <a href="task2ndview.php" class="ong" style="color: #FF6900;text-decoration:none;">Ongoing Tasks<img src="assets/images/arrowiconsidebar.png" style="position: relative;
    width: 9.63px;
    height: 11.95px;
    right: -10px;
    top: -1px;">
	                        ...
	                        <li>
	                            <a href="completedtaskview2.php" class="cmp" style="text-decoration:none;color: #A6A6A6;">Completed Tasks
	                            </a>
	                        </li>
	                    </ul>
	                </li>
...
whatchat();
  ...
  $('#chatmodal').on('show.bs.modal', function(e) {
    ...
    $.ajax({
            type : 'post',
            url : 'https://outre.digital/stage/codee_clean_test/codee_clean/codee_clean_cleanerclient/chatpopuppageclient2.php', //Here you will fetch records
 ...
 <div class="modal fade" id="myModal" role="dialog">
  ...
  <input type="hidden" name="task12" value="add101">
