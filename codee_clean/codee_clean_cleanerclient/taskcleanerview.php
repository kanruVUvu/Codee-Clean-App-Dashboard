...
<head>
    ...
    <title>CODEE App CleanerTasks2ndview</title>
			...
			<div class="sidebar col-md-2" id="sideways">
		        <ul class="menu">
		            <li class="sidebar-item  active">
	                    <a href="taskcleanerview.php" class='sidebar-link'>
	                    ...
	                    <ul class="submenu">
	                        <li>
	                            <a href="taskcleanercompletedview.php" class="ong" style="color: #FF6900;text-decoration:none;">Ongoing Tasks<img src="assets/images/arrowiconsidebar.png" style="position: relative;
    width: 9.63px;
    height: 11.95px;
    right: -10px;
    top: -1px;">
	                        ...
	                        <li>
	                            <a href="taskcleanercompletedview.php" class="cmp" style="text-decoration:none;color: #A6A6A6;">Completed Tasks
	                            </a>
	                        </li>
	                    </ul>
	                </li>
...
height: 1.6px;">TASKS</h2>
			<a href="taskcleanerview.php"><img src="assets/images/listview2.png"class="list1"></a>
			<a href="taskcleaner.php"><img src="assets/images/gridview2.png" class="grid1"></a>
		</div>
				<?php
                    include("database.php");
    ...
    right: -168px;">Not Updated</div>
					...
					<br>
					<img src="assets/images/completedicon.png" style="position: relative;top: -287px;right: -363px;height: 50px;" class="completed" data-toggle="modal" data-target="#myModal3" data-id="<?php echo $row['ID']; ?>">
				</div>
                <?php
                    }
                ?>
...
whatchat();
  ...
  $('#chatmodal').on('show.bs.modal', function(e) {
    ...
    $.ajax({
            type : 'post',
            url : 'https://outre.digital/stage/codee_clean_test/codee_clean/codee_clean_cleanerclient/chatpopuppagecleaner2.php', //Here you will fetch records
  ...
  <div class="modal fade" id="myModal3" role="dialog">
    ...
    text-align: center;">This is to confirm that the cleaning task assigned has been completed as per the management and  client's specification and a photo has been uploaded of the task completed. </p>
       ...
       <input type="hidden" name="delete33" id="delete33" value="task33"/>
       <br/>
	   <br/>
        </div>
...
whatclock();
  ...
  $('#myModal5').on('show.bs.modal', function(e) {
    ...
    $.ajax({
            type : 'post',
            url : 'https://outre.digital/stage/codee_clean_test/codee_clean/codee_clean_cleanerclient/clockcleaner2.php', //Here you will fetch records
