...
<head>
    ...
    <title>CODEE AdminTasksPage</title>
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/js/bootstrap.min.js"></script>
	...
	<style>
	#calendardetailsdecode2:not(:placeholder-shown) { background-image: none;}
	input#calendardetailsdecode2{
 background-image: url(assets/images/modalcalendar.png);
 background-repeat: no-repeat;
 background-position: 534px 20px;
}

input#calendardetailsdecode2:focus{
    		        ...
    		        <ul class="menu">
    		            <li class="sidebar-item  active">
    	                    <a href="task.php" class='sidebar-link'>
    	                        ...
    	                        <a href="task.php" class="taskinfo" style="color:#FF6900;text-decoration:none;">TASK</a>
    	                    </a>
    	                    
    	                    <ul class="submenu">
    	                        <li>
    	                            <a href="task.php" class="ong" style="color:#FF6900;text-decoration:none;">Added by Admin<img src="assets/images/arrowiconsidebar.png" style="position: relative;
    width: 9.63px;
    height: 11.95px;
    right: -10px;
    top: -1px;">
...
whatchat();
  ...
  $('#chatmodal').on('show.bs.modal', function(e) {
    ...
    $.ajax({
            type : 'post',
            url : 'https://outre.digital/stage/codee_clean_test/codee_clean/chatpopuppage1.php', //Here you will fetch records
    ...
    top: -2px;"></center></button>
              ...
              <div class="modal-body21">
                ...
                <div class="form-group">
                    <input placeholder="Scheduled to be completed on" type="text" onfocus="(this.type='date')" onblur="(this.type='text')" class="bday" id="calendardetailsdecode2" name="date" required>
				</div>
                <div class="form-group">
...
whatclock();
  ...
  $('#myModal5').on('show.bs.modal', function(e) {
    ...
    $.ajax({
            type : 'post',
            url : 'https://outre.digital/stage/codee_clean_test/codee_clean/clockadmin1.php', //Here you will fetch records
