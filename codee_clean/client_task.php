...
<head>
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/js/bootstrap.min.js"></script>
	...
	<style>
	#calendardetailsdecode6:not(:placeholder-shown) { background-image: none;}
	input#calendardetailsdecode6{
 background-image: url(assets/images/modalcalendar.png);
 background-repeat: no-repeat;
 background-position: 534px 20px;
}

input#calendardetailsdecode6:focus{
    			...
    			<div class="sidebar col-md-2" id="sideways">
    		        <ul class="menu">
    		            <li class="sidebar-item  active">
    	                    <a href="client_task.php" class='sidebar-link'>
    	                    ...
    	                    <ul class="submenu">
    	                        ...
    	                        <li>
    	                            <a href="client_task.php" class="cmp" style="color:#FF6900;text-decoration:none;">Added by Client<img src="assets/images/arrowiconsidebar.png" style="position: relative;
    width: 9.63px;
    height: 11.95px;
    right: -10px;
    top: -1px;">
...
height: 1.6px;">TASKS</h2>
					<a href="clienttask2ndview.php"><img src="assets/images/List View.png" class="list1"></a>
			<a href="client_task.php"><img src="assets/images/Grid View.png" class="grid1"></a>
                ...
                <div class="col-md-3">
                    <div class="rectangle1">
                        ...
                        <div class="form-group">
							...
							<?php } ?>
							<?php if (!($row['cleaner'])){ ?>
							<img data-id="<?php echo $row['ID']; ?>" src="assets/images/addcleanersmallimage.png" style="position: relative;right: -55px;top: 18px;" class="completed" data-id="<?php echo $row['ID']; ?>" data-toggle="modal" data-target="#Modal4"><p style="position: relative;left: 30.19%;top: -15px;font-family: Nunito Sans;font-style: normal;font-weight: normal;font-size: 18px;line-height: 25px;color: #AA9A9A;">Add Cleaner</p>
							<?php } ?>
							
                        </div>
												<div class="form-group">
                            <div class="line"></div>
							<a href="#" class="completed4" style="text-decoration:none;"><img data-id="<?php echo $row['ID']; ?>" src="assets/images/edit.png" style="position: relative;width: 19px;height: 19px;left: 256px;top: 2px;" data-toggle="modal" data-target="#myModal5"><p data-id="<?php echo $row['ID']; ?>" class="changeb" data-toggle="modal" data-target="#myModal5">Edit</p>
							<br>
							<?php if ($row['clock_in']){ ?>
    ...
    right: -168px;">Not Updated</div>
					...
					<?php if (!($row['cleaner'])) { ?>
					<img src="assets/images/messageicon.png" data-id="<?php echo $row['ID']; ?>" data-toggle="modal" data-target="#chatmodal" style="position: relative;top: -623px;right: -347px;height: 50px;">
					<?php } ?>
					<?php if ($row['cleaner']) { ?>
					<img src="assets/images/messageicon.png" data-id="<?php echo $row['ID']; ?>" data-toggle="modal" data-target="#chatmodal" style="position: relative;top: -576px;right: -347px;height: 50px;">
					<?php } ?>
                </div>
                <?php
                    }
...
whatchat();
  ...
  $('#chatmodal').on('show.bs.modal', function(e) {
    ...
    $.ajax({
            type : 'post',
            url : 'https://outre.digital/stage/codee_clean_test/codee_clean/chatpopuppage3.php', //Here you will fetch records
    ...
    top: -2px;"></center></button>
              ...
              <div class="modal-body21">
                ...
                <div class="form-group">
                    <input placeholder="Scheduled to be completed on" type="text" onfocus="(this.type='date')" onblur="(this.type='text')" class="bday" name="date" id="calendardetailsdecode6" required>
                </div>
                <div class="form-group">
                    <input type="text" placeholder="Site address" name="site_address" class="input_text2" required>
                </div>
                <input type="hidden" name="task3" value="add3">
    ...
    height: 224px;">
	   ...
	   <br/>
        ...
        <div class="modal-footer">
           <input type="button" id="tasksbutton2" class="btn btn-default" data-dismiss="modal" value="CANCEL" onclick="window.location.href='client_task.php'">
...
whatcleaneredit();
  ...
  $('#Modal4').on('show.bs.modal', function(e) {
    ...
    $.ajax({
            type : 'post',
            url : 'https://outre.digital/stage/codee_clean_test/codee_clean/cleanerupdation.php', //Here you will fetch records
...
whatclock();
  ...
  $('#myModal5').on('show.bs.modal', function(e) {
    ...
    $.ajax({
            type : 'post',
            url : 'https://outre.digital/stage/codee_clean_test/codee_clean/clockadmin3.php', //Here you will fetch records
