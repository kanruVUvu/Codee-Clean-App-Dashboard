...
<head>
    ...
    <title>CODEE AdminCompletedTasks2ndview</title>
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/js/bootstrap.min.js"></script>
	...
	<style>
	#calendardetailsdecode3:not(:placeholder-shown) { background-image: none;}
	input#calendardetailsdecode3{
 background-image: url(assets/images/modalcalendar.png);
 background-repeat: no-repeat;
 background-position: 534px 20px;
}

input#calendardetailsdecode3:focus{
    			...
    			<div class="sidebar col-md-2" id="sideways">
    		        <ul class="menu">
    		            <li class="sidebar-item  active">
    	                    <a href="completedtask2ndview.php" class='sidebar-link'>
    	                    ...
    	                    <ul class="submenu">
                                ...
                                <li>
                                    <a href="completedtask2ndview.php" class="completed_task" style="color:#FF6900;text-decoration:none;">Completed Tasks<img src="assets/images/arrowiconsidebar.png" style="position: relative;
    width: 9.63px;
    height: 11.95px;
    right: -10px;
    top: -1px;">
...
height: 1.6px;">TASKS</h2>
			<a href="completedtask2ndview.php"><img src="assets/images/listview2.png" class="list1"></a>
			<a href="completed_task.php"><img src="assets/images/gridview2.png" class="grid1"></a>
    ...
    right: -168px;">Not Updated</div>
					...
					<img src="assets/images/messageicon.png" data-id="<?php echo $row['ID']; ?>" data-toggle="modal" data-target="#chatmodal" style="position: relative;top: -581px;right: -362px;height: 50px;">
                </div>
                <?php
                    }
                ?>
...
whatchat();
  ...
  $('#chatmodal').on('show.bs.modal', function(e) {
    ...
    $.ajax({
            type : 'post',
            url : 'https://outre.digital/stage/codee_clean_test/codee_clean/chatpopuppage6.php', //Here you will fetch records
    ...
    top: -2px;"></center></button>
              ...
              <div class="modal-body21">
                ...
                <div class="form-group">
                    <input placeholder="Scheduled to be completed on" type="text" onfocus="(this.type='date')" onblur="(this.type='text')" class="bday" name="date" id="calendardetailsdecode3" required>
                </div>
                <div class="form-group">
                    <input type="text" placeholder="Site address" name="site_address" class="input_text2" required>
                </div>
                <input type="hidden" name="task6" value="add6">
				<div class="form-group">
    ...
    height: 224px;">
	   ...
	   <br/>
        ...
        <div class="modal-footer">
           <input type="button" id="tasksbutton2" class="btn btn-default" data-dismiss="modal" value="CANCEL" onclick="window.location.href='completedtask2ndview.php'">
...
whatclock();
  ...
  $('#myModal5').on('show.bs.modal', function(e) {
    ...
    $.ajax({
            type : 'post',
            url : 'https://outre.digital/stage/codee_clean_test/codee_clean/clockadmin6.php', //Here you will fetch records
