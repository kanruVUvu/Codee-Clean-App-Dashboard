...
<head>
    ...
    <title>CODEE AdminTasks2ndview</title>
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/js/bootstrap.min.js"></script>
	...
	<style>
	#calendardetailsdecode1:not(:placeholder-shown) { background-image: none;}
	input#calendardetailsdecode1{
 background-image: url(assets/images/modalcalendar.png);
 background-repeat: no-repeat;
 background-position: 534px 20px;
}

input#calendardetailsdecode1:focus{
    			...
    			<div class="sidebar col-md-2" id="sideways">
    		        <ul class="menu">
    		            <li class="sidebar-item  active">
    	                    <a href="task2ndview.php" class='sidebar-link'>
    	                        <img src="assets/images/clipboard 2.png" style="margin-left:30px; margin-top:-6px;"> 
    	                        <a href="task2ndview.php" class="taskinfo" style="color:#FF6900;text-decoration:none;">TASK</a>
    	                    </a>
    	                    
    	                    <ul class="submenu">
    	                        <li>
    	                            <a href="task2ndview.php" class="ong" style="color:#FF6900;text-decoration:none;">Added by Admin<img src="assets/images/arrowiconsidebar.png" style="position: relative;
    width: 9.63px;
    height: 11.95px;
    right: -10px;
    top: -1px;">
    	                        ...
    	                        <li>
    	                            <a href="clienttask2ndview.php" class="cmp" style="text-decoration:none;">Added by Client
    	                            </a>
    	                        </li>
                                <li>
...
height: 1.6px;">TASKS</h2>
					<a href="task2ndview.php"><img src="assets/images/listview2.png" class="list1"></a>
			<a href="task.php"><img src="assets/images/gridview2.png" class="grid1"></a>
                ...
                <div class="col">
                    <div class="rectangle1" style="left: 15px;">
                        ...
                        <div class="form-group">
                            <div class="line"></div>
                            <img src="assets/images/calendar.png" style="margin-left:5%; margin-top:6%;"><lable class="description1">SCHEDULED TO BE COMPLETED ON</lable>
                        ...
                        <div class="form-group">
                            ...
                            <br><img src="assets/images/engineer 3.png" style="margin-left:5%;"><lable class="cleaner">ASSIGNED PERSON</lable>
                              <div class="apt" data-toggle="modal" data-target="#myModal6" data-id="<?php echo $row['ID']; ?>"><img src="assets/images/<?php echo($row['cleanerimage']); ?>" style="width: 28%;">&nbsp;<?php print_r($row['cleaner']); ?></div>
                    						...
                    						<div class="form-group">
                            <div class="line"></div>
							<a href="#" class="completed2" style="text-decoration:none;"><img data-id="<?php echo $row['ID']; ?>" src="assets/images/edit.png" style="position: relative;width: 19px;height: 19px;left: 256px;top: 2px;" data-toggle="modal" data-target="#myModal5"><p data-id="<?php echo $row['ID']; ?>" class="changeb" data-toggle="modal" data-target="#myModal5">Edit</p>
							<br>
							<?php if ($row['clock_in']){ ?>
    ...
    right: -168px;">Not Updated</div>
					...
					<img src="assets/images/messageicon.png" data-id="<?php echo $row['ID']; ?>" data-toggle="modal" data-target="#chatmodal" style="position: relative;top: -500px;right: -362px;height: 50px;">
                </div>
                <?php
                    }
                ?>
...
whatchat();
  ...
  $('#chatmodal').on('show.bs.modal', function(e) {
    ...
    $.ajax({
            type : 'post',
            url : 'https://outre.digital/stage/codee_clean_test/codee_clean/chatpopuppage2.php', //Here you will fetch records
    ...
    top: -2px;"></center></button>
              ...
              <div class="modal-body21">
                ...
                <div class="form-group">
                    <input placeholder="Scheduled to be completed on" type="text" onfocus="(this.type='date')" onblur="(this.type='text')" class="bday" name="date" id="calendardetailsdecode1" required>
                </div>
                <div class="form-group">
                    <input type="text" placeholder="Site address" name="site_address" class="input_text2" required>
                </div>
                <input type="hidden" name="task2" value="add2">
    ...
    height: 224px;">
	   ...
	   <br/>
        ...
        <div class="modal-footer">
          <input type="button" id="tasksbutton2" class="btn btn-default" data-dismiss="modal" value="CANCEL" onclick="window.location.href='task2ndview.php'">
...
what();
  ...
  $('#myModal6').on('show.bs.modal', function(e) {
    ...
    $.ajax({
            type : 'post',
            url : 'https://outre.digital/stage/codee_clean_test/codee_clean/popuppage.php', //Here you will fetch records
...
whatclock();
  ...
  $('#myModal5').on('show.bs.modal', function(e) {
    ...
    $.ajax({
            type : 'post',
            url : 'https://outre.digital/stage/codee_clean_test/codee_clean/clockadmin2.php', //Here you will fetch records
