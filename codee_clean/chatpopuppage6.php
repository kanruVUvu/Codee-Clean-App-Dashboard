...
<?php
    ...
    $q="select * from cleanercompletedtasks where ID='$id'";
...
<div class="modal-header" style="padding: 15px;
    ...
    position: relative;
    top: -22px;
    right: -64%;"><img src="assets/images/location.png"></div><h6 style="font-family: Nunito Sans;
    font-style: normal;
    font-weight: normal;
    font-size: 16px;
    line-height: 22px;
    ...
    font-size: 16px;
    line-height: 22px;
    color: #393939;"><?php echo($row['cleanername']); ?></div>
	<div style="position: relative;
    left: 174px;
    top: -48px;
    font-family: Nunito Sans;
	...
	<input type="hidden" name="chatadminpopup6" value="chatcon6">
    ...
    color: #FFFFFF;
    width: 117px;
    height: 43px;border-color: #FFFFFF;
    border-width: 0px;">&nbsp;&nbsp;&nbsp;<img src="assets/images/biglinearrow.png" style="position: relative;
    top: -100px;
    left: -130px;"><h3 style="position: relative;
    top: -191px;
    left: -32px;
    font-family: Nunito Sans;
    font-style: normal;
    ...
    font-size: 16px;
    line-height: 22px;
    color: #757575;">Send to</h3>
	<select id="usertype" style="font-family: Nunito Sans;
    font-style: normal;
    font-weight: normal;
    font-size: 16px;
    line-height: 22px;
    ...
    border-radius: 8px;
    width: 109px;
    height: 33px;" name="messageforwarding">
