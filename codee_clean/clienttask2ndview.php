...
<head>
    ...
    <title>CODEE ClientTasks2ndview</title>
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/js/bootstrap.min.js"></script>
	...
	<style>
	#calendardetailsdecode5:not(:placeholder-shown) { background-image: none;}
	input#calendardetailsdecode5{
 background-image: url(assets/images/modalcalendar.png);
 background-repeat: no-repeat;
 background-position: 534px 20px;
}

input#calendardetailsdecode5:focus{
...
<script>
  $(document).on("click", ".completed", function () {
   ...
   $(document).on("click", ".completed3", function () {
     var Id3 = $(this).attr('data-id');
     $("#id3").val( Id3 );
   })
   $(document).on("click", ".completed4", function () {
    			...
    			<div class="sidebar col-md-2" id="sideways">
    		        <ul class="menu">
    		            <li class="sidebar-item  active">
    	                    <a href="clienttask2ndview.php" class='sidebar-link'>
    	                        <img src="assets/images/clipboard 2.png" style="margin-left:30px; margin-top:-6px;"> 
    	                        <a href="client_task.php" class="taskinfo" style="color:#FF6900;text-decoration:none;">TASK</a>
    	                    </a>
    	                    
    	                    <ul class="submenu">
    	                        <li>
    	                            <a href="task2ndview.php" class="ong" style="text-decoration:none;">Added by Admin
    	                            </a>
    	                        </li>
    	                        <li>
    	                            <a href="clienttask2ndview.php" class="cmp" style="color:#FF6900;text-decoration:none;">Added by Client<img src="assets/images/arrowiconsidebar.png" style="position: relative;
    width: 9.63px;
    height: 11.95px;
    right: -10px;
    top: -1px;">
                                ...
                                <li>
                                    <a href="completedtask2ndview.php" class="completed_task" style="text-decoration:none;">Completed Tasks
                                    </a>
                                </li>
    	                    </ul>
    	                </li>
...
height: 1.6px;">TASKS</h2>
			<a href="clienttask2ndview.php"><img src="assets/images/listview2.png" class="list1"></a>
			<a href="client_task.php"><img src="assets/images/gridview2.png" class="grid1"></a>
                ...
                <div class="col" style="width:51%">
                    <div class="rectangle1" style="left:15px;">
                        ...
                        <div class="form-group">
                            <img src="assets/images/location.png" style="margin-left: 5%; margin-top:19%;position: relative;top: 0px;"><lable class="site_address"><?php print_r($row['site_address']); ?></lable>
                        </div>
						<br>
						<div class="form-group">
						<div class="line"></div>
                        ...
                        <div class="form-group">
                            <div class="line"></div>
                            <img src="assets/images/calendar.png" style="margin-left:5%; margin-top:6%;"><lable class="description2">SCHEDULED TO BE COMPLETED ON</lable>
                            <div class="date"><?php print_r(date('d M Y' , strtotime($row['completion_scheduled_date']))); ?></div>
                        </div>
                        <div class="form-group">
                            <div class="line"></div>
                            ...
                            <br>
							<?php if ($row['cleaner']){ ?>
							 <div class="apt" data-toggle="modal" data-target="#myModal6" data-id="<?php echo $row['ID']; ?>"><img src="assets/images/<?php echo($row['cleanerimage']); ?>" style="width: 28%;">&nbsp;<?php print_r($row['cleaner']); ?></div>
                        
							<?php } ?>
							<?php if (!($row['cleaner'])){ ?>
							<img src="assets/images/addcleanersmallimage.png" style="position: relative;right: -55px;top: 18px;" class="completed" data-id="<?php echo $row['ID']; ?>" data-toggle="modal" data-target="#Modal4"><p style="position: relative;left: 30.19%;top: -15px;font-family: Nunito Sans;font-style: normal;font-weight: normal;font-size: 18px;line-height: 25px;color: #AA9A9A;">Add Cleaner</p>
							<?php } ?>
							
                        </div>
												<div class="form-group">
                            <div class="line"></div>
							<a href="#" class="completed4" style="text-decoration:none;"><img src="assets/images/edit.png" data-id="<?php echo $row['ID']; ?>" style="position: relative;width: 19px;height: 19px;left: 256px;top: 2px;" data-toggle="modal" data-target="#myModal5"><p class="changeb" data-id="<?php echo $row['ID']; ?>" data-toggle="modal" data-target="#myModal5">Edit</p>
							<br>
							<?php if ($row['clock_in']){ ?>
    ...
    right: -168px;">Not Updated</div>
					...
					<?php if (!($row['cleaner'])) { ?>
					<img src="assets/images/messageicon.png" data-id="<?php echo $row['ID']; ?>" data-toggle="modal" data-target="#chatmodal" style="position: relative;top: -623px;right: -362px;height: 50px;">
					<?php } ?>
					<?php if ($row['cleaner']) { ?>
					<img src="assets/images/messageicon.png" data-id="<?php echo $row['ID']; ?>" data-toggle="modal" data-target="#chatmodal" style="position: relative;top: -576px;right: -362px;height: 50px;">
					<?php } ?>
                </div>
                <?php
                    }
...
whatchat();
  ...
  $('#chatmodal').on('show.bs.modal', function(e) {
    ...
    $.ajax({
            type : 'post',
            url : 'https://outre.digital/stage/codee_clean_test/codee_clean/chatpopuppage4.php', //Here you will fetch records
    ...
    top: -2px;"></center></button>
              ...
              <div class="modal-body21">
                ...
                <div class="form-group">
                    <input placeholder="Scheduled to be completed on" type="text" onfocus="(this.type='date')" onblur="(this.type='text')" class="bday" name="date" id="calendardetailsdecode5" required>
                </div>
                <div class="form-group">
                    <input type="text" placeholder="Site address" name="site_address" class="input_text2" required>
                </div>
                <input type="hidden" name="task4" value="add4">
  ...
  <?php
                            ...
                            { 
                        ?>
<a href="#" class="completed3" data-id="<?php echo $row['ID']; ?>" style="text-decoration:none;"><img src="profileimages/<?php echo($row['cleaner_profilephoto']); ?>"><p class="bb"><?php echo($row['cleaner_name']); ?></p></a>
 <?php } ?>
  </div>
</div>
 <br>
    ...
    height: 224px;">
	   ...
	   <br/>
        ...
        <div class="modal-footer">
           <input type="button" id="tasksbutton2" class="btn btn-default" data-dismiss="modal" value="CANCEL" onclick="window.location.href='clienttask2ndview.php'">
...
what();
  ...
  $('#myModal6').on('show.bs.modal', function(e) {
    ...
    $.ajax({
            type : 'post',
            url : 'https://outre.digital/stage/codee_clean_test/codee_clean/popuppageclient.php', //Here you will fetch records
...
<div class="modal fade" id="Modal4" role="dialog">
    ...
    align-items: center;">
        ...
        <div class="fetched-cleanereditinfo"></div>
      </div>
  ...
  <script>
whatcleaneredit();
        function whatcleaneredit(){
  $('#Modal4').on('show.bs.modal', function(e) {
    var id10 = $(e.relatedTarget).data('id');
    $.ajax({
            type : 'post',
            url : 'https://outre.digital/stage/codee_clean_test/codee_clean/cleanerupdation2.php', //Here you will fetch records
            data :  'id10='+ id10, //Pass $id
            success : function(data){
            $('.fetched-cleanereditinfo').html(data);//Show fetched data from database
            }
        });
  });
}
...
whatclock();
  ...
  $('#myModal5').on('show.bs.modal', function(e) {
    ...
    $.ajax({
            type : 'post',
            url : 'https://outre.digital/stage/codee_clean_test/codee_clean/clockadmin4.php', //Here you will fetch records
